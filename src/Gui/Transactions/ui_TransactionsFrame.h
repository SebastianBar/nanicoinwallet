...
public:
    ...
    void retranslateUi(QFrame *TransactionsFrame)
    {
        ...
        m_transactionsTextLabel->setText(QApplication::translate("TransactionsFrame", "Transacciones", 0));
        m_resetFilterButton->setText(QApplication::translate("TransactionsFrame", "Resetear", 0));
        m_filterButton->setText(QApplication::translate("TransactionsFrame", "Mostrar filtro", 0));
        m_filterTextLabel->setText(QApplication::translate("TransactionsFrame", "PERÍODO", 0));
        m_filterCombo->clear();
        m_filterCombo->insertItems(0, QStringList()
         << QApplication::translate("TransactionsFrame", "Todo", 0)
         << QApplication::translate("TransactionsFrame", "Última hora", 0)
         << QApplication::translate("TransactionsFrame", "Último día", 0)
         << QApplication::translate("TransactionsFrame", "Última semana", 0)
         << QApplication::translate("TransactionsFrame", "Último mes", 0)
         << QApplication::translate("TransactionsFrame", "Último año", 0)
         << QApplication::translate("TransactionsFrame", "Personalizado", 0)
        );
        m_filterBeginTextLabel->setText(QApplication::translate("TransactionsFrame", "DESDE", 0));
        m_filterBeginDtedit->setDisplayFormat(QApplication::translate("TransactionsFrame", "dd MMM yyyy, HH:mm", 0));
        m_filterEndTextLabel->setText(QApplication::translate("TransactionsFrame", "HASTA", 0));
        ...
        m_filterAddressTextLabel->setText(QApplication::translate("TransactionsFrame", "DIRECCIÓN", 0));
        m_exportToCsvButton->setText(QApplication::translate("TransactionsFrame", "Guardar como CSV", 0));
    } // retranslateUi
