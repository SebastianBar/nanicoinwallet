...
"}"));
    ...
    void retranslateUi(QFrame *SendFrame)
    {
        ...
        m_addRecipientButton->setText(QApplication::translate("SendFrame", "+ AGREGAR RECEPTOR", 0));
        label_3->setText(QApplication::translate("SendFrame", "COMISIÓN", 0));
        m_paymentIdTextLabel->setText(QApplication::translate("SendFrame", "ID DE PAGO", 0));
        m_paymentIdEdit->setPlaceholderText(QApplication::translate("SendFrame", "Identificador de pago otorgado por el receptor (tienda, exchange u otra entidad)", 0));
        label->setText(QString());
        m_totalAmountLabel->setText(QApplication::translate("SendFrame", "MONTO", 0));
        m_sendButton->setText(QApplication::translate("SendFrame", "Enviar", 0));
        label_2->setText(QApplication::translate("SendFrame", "MONTO TOTAL", 0));
        m_mixinTextLabel->setText(QApplication::translate("SendFrame", "NIVEL DE ANONIMIDAD", 0));
    } // retranslateUi
