...
"}"));
    ...
    void retranslateUi(QFrame *TransferFrame)
    {
        ...
        m_payToTextLabel->setText(QApplication::translate("TransferFrame", "PAGAR A", 0));
        m_addressBookButton->setText(QApplication::translate("TransferFrame", "Agregar desde contactos", 0));
        m_removeButton->setText(QApplication::translate("TransferFrame", "Eliminar receptor", 0));
        m_amountTextLabel->setText(QApplication::translate("TransferFrame", "MONTO", 0));
        m_labelTextLabel->setText(QApplication::translate("TransferFrame", "ETIQUETA", 0));
        m_sendLabelEdit->setPlaceholderText(QApplication::translate("TransferFrame", "Ingrese una etiqueta a esta dirección para agregarla a tus contactos", 0));
    } // retranslateUi
