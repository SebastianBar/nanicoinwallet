...
"}"));
    ...
    {
        NewAddressDialog->setWindowTitle(QApplication::translate("NewAddressDialog", "Nuevo contacto", 0));
        m_labelTextLabel->setText(QApplication::translate("NewAddressDialog", "ETIQUETA", 0));
        m_cancelButton->setText(QApplication::translate("NewAddressDialog", "Cancelar", 0));
        m_okButton->setText(QApplication::translate("NewAddressDialog", "Aceptar", 0));
        m_addressTextLabel->setText(QApplication::translate("NewAddressDialog", "DIRECCIÓN", 0));
        m_donationCheck->setText(QApplication::translate("NewAddressDialog", "DIRECCIÓN DE DONACIÓN", 0));
        m_donationWarningLabel->setText(QApplication::translate("NewAddressDialog", "Donaciones a esta dirección se detendrán.", 0));
    } // retranslateUi
