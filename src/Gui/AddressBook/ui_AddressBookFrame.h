...
public:
    ...
    void retranslateUi(QFrame *AddressBookFrame)
    {
        ...
        m_addressBookTextLabel->setText(QApplication::translate("AddressBookFrame", "Contactos", 0));
        m_addAddressButton->setText(QApplication::translate("AddressBookFrame", "Agregar contacto", 0));
    } // retranslateUi
