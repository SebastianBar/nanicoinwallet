...
public:
    ...
    void retranslateUi(QFrame *OverviewFrame)
    {
        ...
        m_overviewTransactionsTextLabel->setText(QApplication::translate("OverviewFrame", "Transacciones recientes", 0));
        m_allTransactionsButton->setText(QApplication::translate("OverviewFrame", "Ver historial completo", 0));
    } // retranslateUi
