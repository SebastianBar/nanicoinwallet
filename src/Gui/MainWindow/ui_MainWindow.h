...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/nanicoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutNaniCoinAction = new QAction(MainWindow);
        m_aboutNaniCoinAction->setObjectName(QStringLiteral("m_aboutNaniCoinAction"));
        m_aboutNaniCoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutNaniCoinAction);
        ...
        QObject::connect(m_aboutNaniCoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        m_exitAction->setText(QApplication::translate("MainWindow", "Salir", Q_NULLPTR));
        m_exitAction->setShortcut(QApplication::translate("MainWindow", "Ctrl+Q", Q_NULLPTR));
        m_createWalletAction->setText(QApplication::translate("MainWindow", "Nuevo monedero", Q_NULLPTR));
        m_openWalletAction->setText(QApplication::translate("MainWindow", "Abrir monedero", Q_NULLPTR));
        m_encryptWalletAction->setText(QApplication::translate("MainWindow", "Encriptar monedero", Q_NULLPTR));
        m_changePasswordAction->setText(QApplication::translate("MainWindow", "Cambiar contraseña", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        m_changePasswordAction->setToolTip(QApplication::translate("MainWindow", "Cambiar contraseña", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        m_aboutNaniCoinAction->setText(QApplication::translate("MainWindow", "Acerca de NaniCoin", Q_NULLPTR));
        m_aboutQtAction->setText(QApplication::translate("MainWindow", "Acerca de Qt", Q_NULLPTR));
        m_backupWalletAction->setText(QApplication::translate("MainWindow", "Respaldar monedero", Q_NULLPTR));
        m_autostartAction->setText(QApplication::translate("MainWindow", "Iniciar automáticamente al encender", Q_NULLPTR));
        m_minimizeToTrayAction->setText(QApplication::translate("MainWindow", "Minimizar a la bandeja", Q_NULLPTR));
        m_closeToTrayAction->setText(QApplication::translate("MainWindow", "Cerrar a la bandeja", Q_NULLPTR));
        m_preferencesAction->setText(QApplication::translate("MainWindow", "Preferencias", Q_NULLPTR));
        m_recentWalletsAction->setText(QApplication::translate("MainWindow", "Monederos recientes", Q_NULLPTR));
        m_exportTrackingKeyAction->setText(QApplication::translate("MainWindow", "Exportar llave de seguimiento", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        m_exportTrackingKeyAction->setToolTip(QApplication::translate("MainWindow", "Export llave de seguimiento", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        m_importKeyAction->setText(QApplication::translate("MainWindow", "Importar llave", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        m_importKeyAction->setToolTip(QApplication::translate("MainWindow", "Importar llave", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        m_resetAction->setText(QApplication::translate("MainWindow", "Reiniciar monedero", Q_NULLPTR));
        m_saveKeysAction->setText(QApplication::translate("MainWindow", "Guardar llaves del monedero", Q_NULLPTR));
        m_exportKeyAction->setText(QApplication::translate("MainWindow", "Exportar llave", Q_NULLPTR));
		m_exportPrivateKeyAction->setText(QApplication::translate("MainWindow", "Exportar llave secreta", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        m_exportKeyAction->setToolTip(QApplication::translate("MainWindow", "Exportar llave", Q_NULLPTR));
		m_exportPrivateKeyAction->setToolTip(QApplication::translate("MainWindow", "Exportar llave secreta", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        m_removePendingTxAction->setText(QApplication::translate("MainWindow", "Eliminar TXs pendientes", Q_NULLPTR));
        m_logoLabel->setText(QString());
        m_noWalletLabel->setText(QApplication::translate("MainWindow", "No hay monedero activo", Q_NULLPTR));
        m_walletLabel->setText(QApplication::translate("MainWindow", "Tu dirección:", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        m_addressLabel->setToolTip(QApplication::translate("MainWindow", "Clic para copiar", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        m_addressLabel->setText(QApplication::translate("MainWindow", "DIRECCIÓN", Q_NULLPTR));
        m_notEncryptedIconLabel->setText(QString());
        m_notEncryptedTextLabel->setText(QApplication::translate("MainWindow", "Monedero no encriptado!", Q_NULLPTR));
        m_encryptButton->setText(QApplication::translate("MainWindow", "Configurar contraseña", Q_NULLPTR));
        m_copyAddressButton->setText(QApplication::translate("MainWindow", "Copiar dirección", Q_NULLPTR));
        m_copyAddressLabel->setText(QApplication::translate("MainWindow", "Dirección copiada al portapapeles", Q_NULLPTR));
        m_balanceTextLabel->setText(QApplication::translate("MainWindow", "Saldo total", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        m_balanceLabel->setToolTip(QApplication::translate("MainWindow", "Clic para copiar", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        m_balanceLabel->setText(QApplication::translate("MainWindow", "0.00", Q_NULLPTR));
        m_balanceCopyLabel->setText(QApplication::translate("MainWindow", "Copiado!", Q_NULLPTR));
        m_balanceIconLabel->setText(QString());
        m_overviewButton->setText(QApplication::translate("MainWindow", "GENERAL", Q_NULLPTR));
        m_sendButton->setText(QApplication::translate("MainWindow", "ENVIAR NANICOINS", Q_NULLPTR));
        m_transactionsButton->setText(QApplication::translate("MainWindow", "TRANSACCIONES", Q_NULLPTR));
        m_blockExplorerButton->setText(QApplication::translate("MainWindow", "EXPLORADOR DE BLOQUES", Q_NULLPTR));
        m_addressBookButton->setText(QApplication::translate("MainWindow", "CONTACTOS", Q_NULLPTR));
        m_miningButton->setText(QApplication::translate("MainWindow", "MINADO", Q_NULLPTR));
        menuFile->setTitle(QApplication::translate("MainWindow", "Archivo", Q_NULLPTR));
        menuSettings->setTitle(QApplication::translate("MainWindow", "Configuración", Q_NULLPTR));
        menuThemes->setTitle(QApplication::translate("MainWindow", "Colores", Q_NULLPTR));
        menuHelp->setTitle(QApplication::translate("MainWindow", "Ayuda", Q_NULLPTR));
    } // retranslateUi
