...
public:
    ...
    {
        BlockDetailsDialog->setWindowTitle(QApplication::translate("BlockDetailsDialog", "Detalles del bloque", 0));
        m_blockTextLabel->setText(QApplication::translate("BlockDetailsDialog", "Bloque", 0));
#ifndef QT_NO_TOOLTIP
        m_blockHashLabel->setToolTip(QApplication::translate("BlockDetailsDialog", "Clic para copiar", 0));
#endif // QT_NO_TOOLTIP
        m_blockHashLabel->setText(QApplication::translate("BlockDetailsDialog", "HASH", 0));
        m_copyLabel->setText(QApplication::translate("BlockDetailsDialog", "Copiado!", 0));
        m_blockSizeLabel->setText(QApplication::translate("BlockDetailsDialog", "Tamaño del bloque", 0));
        m_heightTextLabel->setText(QApplication::translate("BlockDetailsDialog", "ALTURA", 0));
        ...
        m_timestampTextLabel->setText(QApplication::translate("BlockDetailsDialog", "FECHA (UTC)", 0));
        m_difficultyLabel->setText(QApplication::translate("BlockDetailsDialog", "TextLabel", 0));
        m_difficultyTextLabel->setText(QApplication::translate("BlockDetailsDialog", "DIFICULTAD", 0));
        m_transactionCountLabel->setText(QApplication::translate("BlockDetailsDialog", "TextLabel", 0));
        m_transactionsSizeTextLabel->setText(QApplication::translate("BlockDetailsDialog", "TAMAÑO TOTAL DE TRANSACCIONES", 0));
        m_orphanTextLabel->setText(QApplication::translate("BlockDetailsDialog", "HUÉRFANO", 0));
        ...
        m_transactionCountTextLabel->setText(QApplication::translate("BlockDetailsDialog", "TRANSACCIONES", 0));
        m_penaltyTextLabel->setText(QApplication::translate("BlockDetailsDialog", "PENALIZACIÓN DE RECOMPENSA", 0));
        m_baseRewardTextLabel->setText(QApplication::translate("BlockDetailsDialog", "RECOMPENSA BASE", 0));
        m_transactionsSizeLabel->setText(QApplication::translate("BlockDetailsDialog", "TextLabel", 0));
        m_blockSizeTextLabel->setText(QApplication::translate("BlockDetailsDialog", "TAMAÑO TOTAL DEL BLOQUE", 0));
        ...
        m_feeTextLabel->setText(QApplication::translate("BlockDetailsDialog", "COMISIÓN DE TRANSACCIONES", 0));
        m_feeLabel->setText(QApplication::translate("BlockDetailsDialog", "TextLabel", 0));
        m_rewardTextLabel->setText(QApplication::translate("BlockDetailsDialog", "RECOMPENSA", 0));
        m_rewardLabel->setText(QApplication::translate("BlockDetailsDialog", "TextLabel", 0));
        m_totalCoinsTextLabel->setText(QApplication::translate("BlockDetailsDialog", "TOTAL DE MONEDAS EN LA RED", 0));
        m_totalCoinsLabel->setText(QApplication::translate("BlockDetailsDialog", "TextLabel", 0));
        m_totalTransactionsTextLabel->setText(QApplication::translate("BlockDetailsDialog", "TOTAL DE TRANSACCIONES EN LA RED", 0));
        ...
        m_blockDetailsTabBar->setTabText(m_blockDetailsTabBar->indexOf(m_transactionsTab), QApplication::translate("BlockDetailsDialog", "Transacciones", 0));
    } // retranslateUi
