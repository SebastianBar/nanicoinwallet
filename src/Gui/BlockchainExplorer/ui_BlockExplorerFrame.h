...
public:
    ...
    void retranslateUi(QFrame *BlockExplorerFrame)
    {
        ...
        m_resetFilterButton->setText(QApplication::translate("BlockExplorerFrame", "Resetear", 0));
        m_blockSearchButton->setText(QApplication::translate("BlockExplorerFrame", "Mostrar búsqueda", 0));
        m_filterTextLabel->setText(QApplication::translate("BlockExplorerFrame", "PERÍODO", 0));
        m_filterCombo->clear();
        m_filterCombo->insertItems(0, QStringList()
         << QApplication::translate("BlockExplorerFrame", "Todo", 0)
         << QApplication::translate("BlockExplorerFrame", "Última hora", 0)
         << QApplication::translate("BlockExplorerFrame", "Último día", 0)
         << QApplication::translate("BlockExplorerFrame", "Última semana", 0)
         << QApplication::translate("BlockExplorerFrame", "Último mes", 0)
         << QApplication::translate("BlockExplorerFrame", "Último año", 0)
         << QApplication::translate("BlockExplorerFrame", "Personalizado", 0)
        );
        m_filterBeginTextLabel->setText(QApplication::translate("BlockExplorerFrame", "DESDE", 0));
        m_filterBeginDtedit->setDisplayFormat(QApplication::translate("BlockExplorerFrame", "dd MMM yyyy, hh:mm", 0));
        m_filterEndTextLabel->setText(QApplication::translate("BlockExplorerFrame", "HASTA", 0));
        m_filterEndDtedit->setDisplayFormat(QApplication::translate("BlockExplorerFrame", "dd MMM yyyy, hh:mm", 0));
        m_filterHashTextLabel->setText(QApplication::translate("BlockExplorerFrame", "HASH / ALTURA", 0));
        m_applyFilterButton->setText(QApplication::translate("BlockExplorerFrame", "Aplicar", 0));
