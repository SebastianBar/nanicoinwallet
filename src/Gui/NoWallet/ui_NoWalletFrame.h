...
"}"));
    ...
    void retranslateUi(QFrame *NoWalletFrame)
    {
        ...
        m_welcomeLabel->setText(QApplication::translate("NoWalletFrame", "Bienvenido al monedero NaniCoin!", 0));
        m_passwordTextLabel->setText(QApplication::translate("NoWalletFrame", "CONTRASEÑA PARA", 0));
        m_walletNameLabel->setText(QString());
        m_walletTextLabel->setText(QApplication::translate("NoWalletFrame", "MONEDERO", 0));
        m_okButton->setText(QApplication::translate("NoWalletFrame", "Aceptar", 0));
        m_createWalletButton->setText(QApplication::translate("NoWalletFrame", "Nuevo monedero", 0));
        m_openWalletButton->setText(QApplication::translate("NoWalletFrame", "Abrir monedero", 0));
    } // retranslateUi
