...
public:
    ...
    void retranslateUi(QFrame *MiningFrame)
    {
        ...
        label->setText(QApplication::translate("MiningFrame", "NÚCLEOS CPU:", 0));
        label_2->setText(QApplication::translate("MiningFrame", "ESTRATEGIA DE SELECCIÓN DE POOL:", 0));
#ifndef QT_NO_TOOLTIP
        m_failoverStrategyRadio->setToolTip(QApplication::translate("MiningFrame", "Iniciar minado en el primer pool. Si falla, pasar al siguiente.", 0));
#endif // QT_NO_TOOLTIP
        m_failoverStrategyRadio->setText(QApplication::translate("MiningFrame", "Failover", 0));
#ifndef QT_NO_TOOLTIP
        m_randomStrategyRadio->setToolTip(QApplication::translate("MiningFrame", "Elige un pool aleatorio de la lista.", 0));
#endif // QT_NO_TOOLTIP
        m_randomStrategyRadio->setText(QApplication::translate("MiningFrame", "Aleatorio", 0));
        m_lockedScreenMiningCheck->setText(QApplication::translate("MiningFrame", "Iniciar minado cuando se bloquee la pantalla", 0));
        m_donationHashRateTextLabel->setText(QApplication::translate("MiningFrame", "Donación:", 0));
        ...
        m_startMiningButton->setText(QApplication::translate("MiningFrame", "Iniciar minado", 0));
        label_6->setText(QApplication::translate("MiningFrame", "Listado de pools de minado", 0));
        label_3->setText(QApplication::translate("MiningFrame", "URL DE POOL", 0));
        label_4->setText(QApplication::translate("MiningFrame", "PUERTO", 0));
        label_5->setText(QApplication::translate("MiningFrame", "DIFICULTAD", 0));
        ...
        m_addPoolButton->setText(QApplication::translate("MiningFrame", "Agregar pool", 0));
    } // retranslateUi
