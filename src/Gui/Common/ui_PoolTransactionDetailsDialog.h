...
public:
    ...
    {
        PoolTransactionDetailsDialog->setWindowTitle(QApplication::translate("PoolTransactionDetailsDialog", "Detalles de transacción", 0));
        m_textLabel->setText(QApplication::translate("PoolTransactionDetailsDialog", "Transacción", 0));
#ifndef QT_NO_TOOLTIP
        m_hashLabel->setToolTip(QApplication::translate("PoolTransactionDetailsDialog", "Clic para copiar", 0));
#endif // QT_NO_TOOLTIP
        m_hashLabel->setText(QApplication::translate("PoolTransactionDetailsDialog", "HASH", 0));
        m_copyLabel->setText(QApplication::translate("PoolTransactionDetailsDialog", "Copiado!", 0));
        m_amountTextLabel->setText(QApplication::translate("PoolTransactionDetailsDialog", "MONTO", 0));
        m_sizeTextLabel->setText(QApplication::translate("PoolTransactionDetailsDialog", "TAMAÑO", 0));
        ...
        m_paymentIdTextLabel->setText(QApplication::translate("PoolTransactionDetailsDialog", "ID DE PAGO", 0));
        ...
        m_feeTextLabel->setText(QApplication::translate("PoolTransactionDetailsDialog", "COMISIÓN", 0));
