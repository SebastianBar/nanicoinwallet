...
"}"));
    ...
    {
        NewPasswordDialog->setWindowTitle(QApplication::translate("NewPasswordDialog", "Ingrese contraseña", 0));
        m_passwordTextLabel->setText(QApplication::translate("NewPasswordDialog", "CONTRASEÑA", 0));
        m_cancelButton->setText(QApplication::translate("NewPasswordDialog", "Cancelar", 0));
        m_okButton->setText(QApplication::translate("NewPasswordDialog", "Aceptar", 0));
        m_passwordConfirmationTextLabel->setText(QApplication::translate("NewPasswordDialog", "CONFIRMAR", 0));
    } // retranslateUi
