...
void NewPasswordDialog::setConfirmPasswordError(bool _error) {
  ...
  m_ui->m_passwordConfirmationTextLabel->setText(_error ? tr("CONTRASEÑAS NO COINCIDEN") : tr("CONFIRMAR"));
...
void NewPasswordDialog::setEmptyPasswordError(bool _error) {
  ...
  m_ui->m_passwordTextLabel->setText(_error ? tr("CONTRASEÑA VACÍA") : tr("CONTRASEÑA"));
