...
public:
    ...
    {
        AddressBookDialog->setWindowTitle(QApplication::translate("AddressBookDialog", "Seleccionar dirección", 0));
        m_okButton->setText(QApplication::translate("AddressBookDialog", "Elegir", 0));
    } // retranslateUi
