...
public:
    ...
    {
        KeyDialog->setWindowTitle(QApplication::translate("KeyDialog", "Llave", 0));
        m_descriptionLabel->setText(QString());
        m_fileButton->setText(QApplication::translate("KeyDialog", "Archivo", 0));
        m_cancelButton->setText(QApplication::translate("KeyDialog", "Cancelar", 0));
        m_okButton->setText(QApplication::translate("KeyDialog", "Aceptar", 0));
    } // retranslateUi
