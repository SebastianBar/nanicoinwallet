...
public:
    ...
    {
        TransactionDetailsDialog->setWindowTitle(QApplication::translate("TransactionDetailsDialog", "Detalles de transacción", 0));
        m_textLabel->setText(QApplication::translate("TransactionDetailsDialog", "Transacción", 0));
#ifndef QT_NO_TOOLTIP
        m_hashLabel->setToolTip(QApplication::translate("TransactionDetailsDialog", "Clic para copiar", 0));
#endif // QT_NO_TOOLTIP
        m_hashLabel->setText(QApplication::translate("TransactionDetailsDialog", "HASH", 0));
        m_copyLabel->setText(QApplication::translate("TransactionDetailsDialog", "Copiado!", 0));
        m_statusTextLabel->setText(QApplication::translate("TransactionDetailsDialog", "ESTADO", 0));
        m_statusLabel->setText(QApplication::translate("TransactionDetailsDialog", "TextLabel", 0));
        m_timeTextLabel->setText(QApplication::translate("TransactionDetailsDialog", "FECHA", 0));
        m_timeLabel->setText(QApplication::translate("TransactionDetailsDialog", "TextLabel", 0));
        m_heightTextLabel->setText(QApplication::translate("TransactionDetailsDialog", "ALTURA DE BLOQUE", 0));
        m_heightLabel->setText(QApplication::translate("TransactionDetailsDialog", "TextLabel", 0));
        m_toTextLabel->setText(QApplication::translate("TransactionDetailsDialog", "TRANSFERENCIAS", 0));
        m_toLabel->setText(QApplication::translate("TransactionDetailsDialog", "TextLabel", 0));
        m_amountTextLabel->setText(QApplication::translate("TransactionDetailsDialog", "MONTO", 0));
        m_amountLabel->setText(QApplication::translate("TransactionDetailsDialog", "TextLabel", 0));
        m_feeTextLabel->setText(QApplication::translate("TransactionDetailsDialog", "COMISIÓN", 0));
        m_feeLabel->setText(QApplication::translate("TransactionDetailsDialog", "TextLabel", 0));
        m_paymentIdTextLabel->setText(QApplication::translate("TransactionDetailsDialog", "ID DE PAGO", 0));
        ...
        m_transactionDetailsTabBar->setTabText(m_transactionDetailsTabBar->indexOf(m_transfersTab), QApplication::translate("TransactionDetailsDialog", "Transferencias", 0));
    } // retranslateUi
