...
void ChangePasswordDialog::setConfirmPasswordError(bool _error) {
  ...
  m_ui->m_newPasswordConfirmationTextLabel->setText(_error ? tr("CONTRASEÑAS NO COINCIDEN") : tr("CONFIRMAR"));
...
void ChangePasswordDialog::setEmptyPasswordError(bool _error) {
  ...
  m_ui->m_newPasswordTextLabel->setText(_error ? tr("CONTRASEÑA VACÍA") : tr("NUEVA CONTRASEÑA"));
...
void ChangePasswordDialog::setOldPasswordError(bool _error) {
  ...
  m_ui->m_oldPasswordTextLabel->setText(_error ? tr("CONTRASEÑA INCORRECTA") : tr("CONTRASEÑA ANTIGUA"));
