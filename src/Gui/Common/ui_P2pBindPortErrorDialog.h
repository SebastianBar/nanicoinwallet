...
public:
    ...
    {
        P2pBindPortErrorDialog->setWindowTitle(QApplication::translate("P2pBindPortErrorDialog", "Advertencia", 0));
        m_portErrorLabel->setText(QApplication::translate("P2pBindPortErrorDialog", "El puerto P2P %1 está siendo usado. Para continuar por favor seleccione:", 0));
        m_acceptRadio->setText(QString());
        label_2->setText(QApplication::translate("P2pBindPortErrorDialog", "Asignar a", 0));
        label_3->setText(QApplication::translate("P2pBindPortErrorDialog", "puerto", 0));
        m_rejectRadio->setText(QString());
        label->setText(QApplication::translate("P2pBindPortErrorDialog", "Salir", 0));
        m_okButton->setText(QApplication::translate("P2pBindPortErrorDialog", "Aceptar", 0));
    } // retranslateUi
