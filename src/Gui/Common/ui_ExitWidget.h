...
public:
    ...
    {
        ExitWidget->setWindowTitle(QApplication::translate("ExitWidget", "Guardando datos", 0));
        label->setText(QApplication::translate("ExitWidget", "El monedero NaniCoin está guardando datos.\n"
"Por favor espere...", 0));
    } // retranslateUi
