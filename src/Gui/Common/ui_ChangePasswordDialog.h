...
"}"));
    ...
    {
        ChangePasswordDialog->setWindowTitle(QApplication::translate("ChangePasswordDialog", "Cambiar contraseña", 0));
        m_newPasswordTextLabel->setText(QApplication::translate("ChangePasswordDialog", "NUEVA CONTRASEÑAAR", 0));
        m_newPasswordConfirmationTextLabel->setText(QApplication::translate("ChangePasswordDialog", "CONFIRM", 0));
        m_oldPasswordTextLabel->setText(QApplication::translate("ChangePasswordDialog", "CONTRASEÑA ANTIGUA", 0));
        m_cancelButton->setText(QApplication::translate("ChangePasswordDialog", "Cancelar", 0));
        m_okButton->setText(QApplication::translate("ChangePasswordDialog", "Aceptar", 0));
    } // retranslateUi
