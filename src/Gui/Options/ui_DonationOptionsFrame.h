...
public:
    ...
    void retranslateUi(QFrame *DonationOptionsFrame)
    {
        ...
        m_enableDonationMiningCheck->setText(QApplication::translate("DonationOptionsFrame", "Minería de donación", 0));
        label_2->setText(QApplication::translate("DonationOptionsFrame", "% de hashes a ser donados", 0));
        m_donationMiningAmountSpin->setSuffix(QApplication::translate("DonationOptionsFrame", "%", 0));
        m_donationMiningCommentLabel->setText(QApplication::translate("DonationOptionsFrame", "La minería de donación permite contribuir un porcentaje fijo de tu minado a una dirección NaniCoin de tu elección.", 0));
        label->setText(QApplication::translate("DonationOptionsFrame", "Dirección para donaciones", 0));
        label_5->setText(QApplication::translate("DonationOptionsFrame", "(Direcciones de donación pueden ser agregadas en Contactos)", 0));
        m_enableDonationChangeCheck->setText(QApplication::translate("DonationOptionsFrame", "Donación aleatoria en cada transacción", 0));
        label_3->setText(QApplication::translate("DonationOptionsFrame", "% máximo de transacción a ser donado", 0));
        m_donationChangeCommentLabel->setText(QApplication::translate("DonationOptionsFrame", "El porcentaje de donación es aleatorio y no podrá exceder lo configurado en el costado izquierdo.", 0));
        m_donationChangeAmountSpin->setSuffix(QApplication::translate("DonationOptionsFrame", "%", 0));
        label_4->setText(QApplication::translate("DonationOptionsFrame", "Dirección para donaciones", 0));
        label_6->setText(QApplication::translate("DonationOptionsFrame", "(Direcciones de donación pueden ser agregadas en Contactos)", 0));
    } // retranslateUi
