...
public:
    ...
    void retranslateUi(QFrame *OptimizationOptionsFrame)
    {
        ...
        m_enableOptimizationCheck->setText(QApplication::translate("OptimizationOptionsFrame", "Ejecutar optimización de monedero en segundo plano", 0));
        label_8->setText(QApplication::translate("OptimizationOptionsFrame", "(DESACTIVADO)", 0));
        label_5->setText(QApplication::translate("OptimizationOptionsFrame", "Objetivo de optimización", 0));
        label_7->setText(QApplication::translate("OptimizationOptionsFrame", "Nivel de anonimidad", 0));
        m_nonOptimizedOutputsLabel->setText(QApplication::translate("OptimizationOptionsFrame", "0", 0));
        m_nonOptimizedOutputsTextLabel->setText(QApplication::translate("OptimizationOptionsFrame", "Salida bajo el objetivo seleccionado", 0));
        label_2->setText(QApplication::translate("OptimizationOptionsFrame", "Desde", 0));
        m_startTimeEdit->setDisplayFormat(QApplication::translate("OptimizationOptionsFrame", "HH:mm", 0));
        label_3->setText(QApplication::translate("OptimizationOptionsFrame", "Hasta", 0));
        m_stopTimeEdit->setDisplayFormat(QApplication::translate("OptimizationOptionsFrame", "HH:mm", 0));
        m_optimizationTimeCheck->setText(QApplication::translate("OptimizationOptionsFrame", "Tiempo específico para optimización de transacciones", 0));
        label_4->setText(QApplication::translate("OptimizationOptionsFrame", "Enviar optimización de transacciones cada", 0));
        m_showFusionTransactionsCheck->setText(QApplication::translate("OptimizationOptionsFrame", "Mostrar transacciones de optimización", 0));
        m_helpLabel->setText(QApplication::translate("OptimizationOptionsFrame", "La optimización del monedero es una tarea en segundo plano realizada con el fin de combinar salidas de transacciones que están bajo el objetivo de optimización en otras mas grandes. Hace más económico enviar grandes cantidades de NaniCoins en una sola transacción.\n"
"La optimización de monedero es gratuita para todos los usuarios pero tarda algún tiempo.", 0));
    } // retranslateUi
