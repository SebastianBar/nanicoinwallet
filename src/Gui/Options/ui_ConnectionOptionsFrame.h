...
public:
    ...
    void retranslateUi(QFrame *ConnectionOptionsFrame)
    {
        ...
        m_autoRadio->setText(QApplication::translate("ConnectionOptionsFrame", "Selección automática", 0));
        m_autoHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "El monedero se conectará a un daemon corriendo localmente en el puerto 22176. En el caso que no haya un daemon en ejecución, un nodo integrado en el monedero será utilizado.", 0));
        m_embeddedRadio->setText(QApplication::translate("ConnectionOptionsFrame", "Integrado", 0));
        m_embeddedHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Un nodo integrado en el monedero será utilizado.", 0));
        m_localRadio->setText(QApplication::translate("ConnectionOptionsFrame", "Daemon local", 0));
        label->setText(QApplication::translate("ConnectionOptionsFrame", "Puerto:", 0));
        m_localHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "El monedero se conectará aun daemon de NaniCoin local. Por favor especifique el puerto del daemon.", 0));
        m_remoteRadio->setText(QApplication::translate("ConnectionOptionsFrame", "Daemon remoto", 0));
        label_2->setText(QApplication::translate("ConnectionOptionsFrame", "Host:", 0));
        label_3->setText(QApplication::translate("ConnectionOptionsFrame", "Puerto:", 0));
        m_remoteHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "El monedero se conectará a un nodo NaniCoin en ejecución en otro PC en la red local o en internet. Por favor especifique la dirección IP o nombre de dominio y el puerto.", 0));
    } // retranslateUi
