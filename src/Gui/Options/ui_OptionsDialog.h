...
public:
    ...
    {
        OptionsDialog->setWindowTitle(QApplication::translate("OptionsDialog", "Preferencias", 0));
        m_optionsTabWidget->setTabText(m_optionsTabWidget->indexOf(m_connectionTab), QApplication::translate("OptionsDialog", "Conexión", 0));
        m_optionsTabWidget->setTabText(m_optionsTabWidget->indexOf(m_optimizationTab), QApplication::translate("OptionsDialog", "Optimización", 0));
        m_optionsTabWidget->setTabText(m_optionsTabWidget->indexOf(m_donationTab), QApplication::translate("OptionsDialog", "Donaciones", 0));
        m_optionsTabWidget->setTabText(m_optionsTabWidget->indexOf(m_privacyTab), QApplication::translate("OptionsDialog", "Privacidad", 0));
        m_warningLabel->setText(QApplication::translate("OptionsDialog", "¡Atención! Debe reiniciar el monedero para aplicar los cambios.", 0));
        m_cancelButton->setText(QApplication::translate("OptionsDialog", "Cancelar", 0));
        m_okButton->setText(QApplication::translate("OptionsDialog", "Guardar", 0));
    } // retranslateUi
