...
public:
    ...
    void retranslateUi(QFrame *PrivacyFrame)
    {
        ...
        m_newsCheck->setText(QApplication::translate("PrivacyFrame", "Quiero ver noticias de NaniCoin", 0));
        m_embeddedHelperLabel->setText(QApplication::translate("PrivacyFrame", "Marcando esta casilla resultará en una vista general actualizada. Ahora te mostrará las últimas publicaciones de NaniCoin, otorgándote las últimas noticias de NaniCoin.", 0));
    } // retranslateUi
