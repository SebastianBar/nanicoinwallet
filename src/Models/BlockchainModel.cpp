...
QVariant BlockchainModel::data(const QModelIndex &_index, int _role) const {
  ...
  case Qt::EditRole: {
    ...
    case COLUMN_BLOCK_IS_ORPHANED:
      return _index.data(ROLE_BLOCK_IS_ORPHANED).toBool() ? tr("Si") : tr("No");
    case COLUMN_BLOCK_TRANSACTION_COUNT:
